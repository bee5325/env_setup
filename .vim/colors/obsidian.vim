...
let s:Colors = [
\'#a082bd','#e0e2e4','#93c763','#ffcd22','#ec7600',
\'#ff8409','#e8e2b7','#d39745','#66747b','#678cb1',
\'#5899c0','#5ab9be','#293134','#014343','#f3db2e',
...
execute "hi Todo guifg="        . s:Colors[18] . " guibg=" . s:Colors[12] . " gui=bold guisp=NONE"
...
" For ALE
"
execute "hi ALESignColumnWithErrors guifg=NONE" . " guibg=" . s:Colors[19]
execute "hi ALESignColumnWithoutErrors guifg=NONE" . " guibg=" . s:Colors[23]
execute "hi ALEErrorSign guifg=" . s:Colors[20] . " guibg=" . s:Colors[19]
execute "hi ALEWarningSign guifg=" . s:Colors[21] . " guibg=" . s:Colors[19]
